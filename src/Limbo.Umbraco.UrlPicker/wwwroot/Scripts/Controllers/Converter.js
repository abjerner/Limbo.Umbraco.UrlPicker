angular.module("umbraco").controller("Limbo.Umbraco.UrlPicker.Converter.Controller", function ($scope, $http, editorService) {
    ...
    vm.changed = function () {
        $scope.model.value = vm.selected ? vm.selected.type : "";
    };
    ...
    vm.add = function () {
        ...
        editorService.open({
            ...
            size: "medium",
            view: `/App_Plugins/Limbo.Umbraco.UrlPicker/Views/ConverterOverlay.html?v=${v}`,
            filter: true,
    ...
    function init() {
        ...
        $http.get(`${baseUrl}/backoffice/Limbo/UrlPicker/GetConverters`).then(function (response) {
